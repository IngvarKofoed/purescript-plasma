...
var showReadyState = new Data_Show.Show(function (v) {
    ...
    throw new Error("Failed pattern match at DOM.File.FileReader.ReadyState line 29, column 3 - line 30, column 3: " + [ v.constructor.name ]);
});
...
var ordReadyState = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at DOM.File.FileReader.ReadyState line 13, column 1 - line 13, column 48: " + [ x.constructor.name, y.constructor.name ]);
    };
});
