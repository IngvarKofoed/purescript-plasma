...
var enumOrdering = new Enum(function () {
    ...
    throw new Error("Failed pattern match at Data.Enum line 76, column 3 - line 76, column 20: " + [ v.constructor.name ]);
}, function (v) {
    if (v instanceof Data_Ordering.LT) {
        return new Data_Maybe.Just(Data_Ordering.EQ.value);
    };
    ...
    throw new Error("Failed pattern match at Data.Enum line 73, column 3 - line 73, column 20: " + [ v.constructor.name ]);
});
var enumMaybe = function (dictBoundedEnum) {
    return new Enum(function () {
        ...
        throw new Error("Failed pattern match at Data.Enum line 83, column 3 - line 83, column 25: " + [ v.constructor.name ]);
    }, function (v) {
        if (v instanceof Data_Maybe.Nothing) {
        ...
        throw new Error("Failed pattern match at Data.Enum line 81, column 3 - line 81, column 36: " + [ v.constructor.name ]);
    });
};
...
var enumEither = function (dictBoundedEnum) {
    return function (dictBoundedEnum1) {
        return new Enum(function () {
            ...
            throw new Error("Failed pattern match at Data.Enum line 89, column 3 - line 89, column 59: " + [ v.constructor.name ]);
        }, function (v) {
            if (v instanceof Data_Either.Left) {
            ...
            throw new Error("Failed pattern match at Data.Enum line 87, column 3 - line 87, column 71: " + [ v.constructor.name ]);
        });
    };
};
...
var defaultToEnum = function (dictBounded) {
    return function (dictEnum) {
        return function (n) {
            ...
            throw new Error("Failed pattern match at Data.Enum line 240, column 1 - line 243, column 47: " + [ n.constructor.name ]);
        };
    };
};
...
var boundedEnumOrdering = new BoundedEnum(function () {
    ...
    throw new Error("Failed pattern match at Data.Enum line 194, column 3 - line 195, column 3: " + [ v.constructor.name ]);
}, function (v) {
    if (v === 0) {
        return new Data_Maybe.Just(Data_Ordering.LT.value);
    };
...
var boundedEnumEither = function (dictBoundedEnum) {
    return function (dictBoundedEnum1) {
        return new BoundedEnum(function () {
            ...
            throw new Error("Failed pattern match at Data.Enum line 216, column 3 - line 216, column 33: " + [ v.constructor.name ]);
        }, function (n) {
            var to = function (v) {
                if (n >= 0 && n < v) {
                ...
                throw new Error("Failed pattern match at Data.Enum line 213, column 5 - line 215, column 46: " + [ v.constructor.name ]);
            };
...
var boundedEnumBoolean = new BoundedEnum(function () {
    ...
    throw new Error("Failed pattern match at Data.Enum line 174, column 3 - line 175, column 3: " + [ v.constructor.name ]);
}, function (v) {
    if (v === 0) {
        return new Data_Maybe.Just(false);
    };
