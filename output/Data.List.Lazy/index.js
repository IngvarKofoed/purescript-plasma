        ...
        return function (ys) {
            var go = function (v) {
                return function (v1) {
                    ...
                    throw new Error("Failed pattern match at Data.List.Lazy line 663, column 3 - line 663, column 17: " + [ v.constructor.name, v1.constructor.name ]);
                };
            };
...
var take = function (n) {
    var go = function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 486, column 3 - line 486, column 24: " + [ v.constructor.name, v1.constructor.name ]);
        };
    };
    return function ($213) {
...
var replicateM = function (dictMonad) {
    return function (n) {
        return function (m) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 160, column 1 - line 165, column 23: " + [ n.constructor.name, m.constructor.name ]);
        };
    };
};
...
var range = function (start) {
    return function (end) {
        ...
        throw new Error("Failed pattern match at Data.List.Lazy line 144, column 1 - line 152, column 30: " + [ start.constructor.name, end.constructor.name ]);
    };
};
...
var mapMaybe = function (f) {
    var go = function (__copy_v) {
        ...
        function __tco_loop(v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 454, column 14 - line 460, column 39: " + [ v.constructor.name ]);
        };
        while (!__tco_done) {
    ...
    var go = function (__copy_v) {
        return function (__copy_v1) {
            ...
            function __tco_loop(v, v1) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 295, column 12 - line 299, column 42: " + [ v.constructor.name, v1.constructor.name ]);
            };
            while (!__tco_done) {
...
var filter = function (p) {
    var go = function (__copy_v) {
        ...
        function __tco_loop(v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 424, column 12 - line 429, column 31: " + [ v.constructor.name ]);
        };
        while (!__tco_done) {
            __tco_result = __tco_loop(__copy_v);
        };
    ...
    var go = function (__copy_v) {
        return function (__copy_v1) {
            ...
            function __tco_loop(v, v1) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 503, column 10 - line 507, column 44: " + [ v.constructor.name, v1.constructor.name ]);
            };
            while (!__tco_done) {
                __tco_result = __tco_loop(__tco_v, __copy_v1);
            };
